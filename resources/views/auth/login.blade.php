...
<head>
    ...
    <!-- Site Properties -->
    <title>Connexion | Transfert d'argent rapide et sécurisé - Canada - Afrique</title>
                        ...
                        <div class="uk-grid uk-flex-center">
                            <div class="uk-width-3-5@m">
                                <div class="in-padding-horizontal@s">
                                    ...
                                    <!-- logo end -->
                                    <p class="uk-text-lead uk-margin-top uk-margin-remove-bottom">Connectez-vous</p>
                                    ...
                                    <form class="uk-grid uk-form" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                                            ...
                                            <input type="password" class="uk-input uk-border-rounded @error('password') is-invalid @enderror" name="password" placeholder="Votre mot de passe">
                                            @error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="uk-margin-small uk-width-auto uk-text-small">
                                            <label>
                                                <input class="uk-checkbox uk-border-rounded" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
                                                Se souvenir de moi</label>
                                        </div>
                                        <div class="uk-margin-small uk-width-expand uk-text-small">
                                            <label class="uk-align-right"><a class="uk-link-reset" href="{{ route('password.request') }}">Mot de passe
                                                    oublié?</a></label>
                                        </div>
                                        <div class="uk-margin-small uk-width-1-1">

                                                <button type="submit" class="uk-button uk-width-1-1 bg-primary uk-border-rounded uk-float-left">Connexion</button>
                                        </div>
                                    </form>
                                    <!-- login form end -->
