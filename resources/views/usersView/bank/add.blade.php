    ...
    <div class="row">
        ...
        <div class="content-edit-area">
            ...
            <div class="edit-content">
                <form id="add-Card" method="post" action="{{ route('u.bank.add.save') }}">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="numberCard" required value="{{ @old('numberCard') }}"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input name="dateExp" type="month" class="form-control" required
                                    value="{{@old('dateExp')}}" placeholder="MM/YY">
                                @error('dateExp')
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input  value="{{@old('cvv')}}" id="cvvNumber" type="password" class="form-control"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nameCard" value="{{ @old('nameCard') }}" required placeholder="Nom sur la carte">
                            </div>
                            @error('nameCard')
